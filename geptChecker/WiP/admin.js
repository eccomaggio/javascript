    "use strict";
    console.clear();
    const versionNumber = "8.0";
    const versionDetails = "*New GEPT wordlist; includes GZ6K & ref2k lists; edits 'in place'; *advises on preferred spellings; *recognizes negative prefixes and superfluous hyphens; *custom level strike-through; *preserves original spacing/punctuation; includes GZ6K high school list\n[nerdy]\n+all html output now escaped through Tag.stringify(); +implemented all functions as classes; +font size now saved between sessions; +kids now displays levelstats";
