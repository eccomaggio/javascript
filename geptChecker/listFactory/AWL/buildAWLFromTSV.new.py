"""
This takes in a csv file [AWL_base_file.tsv] (based on the table at https://www.eapfoundation.com/vocab/academic/awllists/#:~:text=in%20the%20AWL.-,the%20academic%20word%20list,-Headword) which consists of three cols:
1) headword
2) sublist number
...
Several time-saving guesses are made (which are corrected if wrong by the awl_pos_corrections_dict.json):
UK spelling
Part of speech
